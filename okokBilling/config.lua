...
Config.InvoicesCommand = 'fatture' -- Command used to open the invoices menu

Config.VATPercentage = 22 -- Visual only, it won't influence the final invoice value, change it to your country VAT value
...
Config.BotName = 'Force' -- Write the desired bot name

Config.ServerName = 'Force' -- Write your server's name
